...
# tienda del pais). Lista compartida con actualizar_stock.py (que ademas
# agrega la disponibilidad real por tienda de estos materiales), ver
# materiales_nuevos.py.
